<!-- loio8d23bc7b55ef450682547d220e0cbcf3 -->
...
Typical use case: you would create a dynamic user list for a department where users change over time as people join and leave the department.
...
> 
> For more information, see [Managing Internal Users](managing-internal-users-888ef2f.md), and scroll down to the section *Internal users from specific areas*.
