...
<a name="loiod1a7b42015084959952f18ee5c5568f3__prereq_eyv_5wj_lyb"/>
...
5.  Choose *Finish*.
    ...
    You’ve successfully created a workspace template project. You can now perform the following actions:
    ...
    -   Delete the workspace template: To do so, navigate to the newly created project. Right-click on the project and select *Delete*.
