...
# How to Use Links in Your Workspace

If the members of a workspace frequently access specific web pages, external web applications, or folders in the workspace, it can be convenient to display links to them permanently in a *Content* widget or on a *Content* l tab. For this purpose, you can create links as content items.
...
1.  Go to the *Content* list of a workspace.
