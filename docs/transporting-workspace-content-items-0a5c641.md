<!-- loio0a5c641b168f4d9b8302afa00a113d58 -->

# Transporting Workspace Content Items

You can transport content items such as home pages, workspaces, workspace content, and workspace templates.

To transport content items between subaccounts, you simply export the content from the source system and import the exported file back into the target system.
...
3.  Transport your home page and its content as follows:
    ...
    1.  In the source home page management screen, click *Import and Export Home Page*.
...
3.  Transport a workspace with all its content as follows:
    ...
    1.  In the target workspaces management screen, open the *Import Workspace* tab.
...
<a name="loio0a5c641b168f4d9b8302afa00a113d58__section_e24_lgb_fdc"/>

## Exporting large files

When the total file size of an exported workspace, workspace content, or workspace template exceeds 50MB, a direct file download won't happen. Instead, an export job will be triggered, and only when finished, the file download will be possible from the User Profile screen under the *My Exports* area. From here the user can download their large file.
