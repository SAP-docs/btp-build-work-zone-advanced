...
> ### Note:  
> The following settings apply only to the Digital Workplace Service \(DWS\) component of the product. For more information about the overall trust settings, see [User Authentication and Authorization](user-authentication-and-authorization-f04c185.md).
...
*External Integrations* \> [Upload a Trusted Certificate Authority](upload-a-trusted-certificate-authority-0f5c6b2.md)
...
*External Integrations* \> [OAuth Clients](oauth-clients-b3c804e.md)
...
> 
> -   See [Upload a Trusted Certificate Authority](upload-a-trusted-certificate-authority-0f5c6b2.md) if the external application to SAP Build Work Zone, advanced edition requires OAuth authorization.
