...
# How to Manage Documents and Images in Workspaces
...
> ### Note:  
> The size limit for any file \(such as documents, images, ZIP files, and more\), that can be uploaded, is 2GB.

You can upload one or more files at the same time to the *Content* list of your workspace. Note that the files that you upload for your workspace are maintained in your workspace. You cannot maintain workspace content from the Content section of your own profile, as the content stored there is independent of workspace content.

To upload one or more files, to the *Content* list of a workspace, choose <span class="SAP-icons-V5"></span> .

-   File types that can be uploaded include spreadsheets, PDFs, slides, and documents. Some content may provide a preview.

-   File types that can't be uploaded include `jar`, `html`, `svg`, and `exe`.

-   File types that can be used when uploading images include `JPEG`, `JPG`, `PNG`, `GIF`, `BMP`, and `WBMP`.
...
On the *Content* page tab of a workspace, you can select multiple files or content folders and choose the <span class="SAP-icons-V5"></span> menu and then *Download selected items …* to download them in a single zip file.
...
[Content Permissions](content-permissions-8f317cb.md "As a content owner who has uploaded a document or image, you can set permissions for what can be done with the content. You can also set permissions when you create a wiki or knowledge base article, right before you publish or save it.")
