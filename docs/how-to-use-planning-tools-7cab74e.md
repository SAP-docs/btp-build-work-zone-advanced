<!-- loio7cab74e1b3a64854aedffc86bd6af732 -->

# How to Use Planning Tools

Planning tools help you plan and coordinate projects with workspace members.



To see all the planning tools in a workspace, open the *Content* list of the workspace.

You can open the content list by adding a *Content* navigation tab to your workspace navigation bar. From the *Content* list, select *\+ Create* and select *Planning Tools*.
...
Create a list of agenda topics with an optional start date and time. The agenda organizer and any workspace member can add topics to be discussed at the meeting, and set time duration for each topic. Agendas can be attached to events.
...
5.  Rearrange the order of the agenda by dragging and dropping the agenda item.

    > ### Note:  
    > Whenever you make a change to the agenda, a feed item is also created for the change.
...
1.  Click the *\+ Add Task* field. to add a task and provide a name for it.
2.  Add a title.
3.  Enter a description for the task.
4.  Assign the task to other workspace members. You are automatically assigned to the task. You can remove yourself if not applicable.
5.  Click the date field to specify a due date.
6.  Define whether you want a reminder.
7.  Choose a priority \(i.e., Low, Medium, or High\).
8.  If you need to attach an existing content item, add tags, or add followers, click *More Task Options*.
9.  Click *OK*.
