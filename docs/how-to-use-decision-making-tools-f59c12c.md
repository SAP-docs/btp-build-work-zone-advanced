<!-- loiof59c12cfef1e4f42b1520633697f569b -->
...
To see all the decision-making tools in a workspace, open the *Content* list of the workspace. You can open the content list by adding a *Content* navigation tab to your workspace. From the *Content* list, select *\+ Create* and select *Decision-Making Tools*.
...
Describes what decision needs to be made. Once it's been decided, you can record and lock your decision, and select workspace members to sign off on it. You can always reopen and change the decision.
...
3.  Click *Save*. The description displays in the text box and a *We decided...* button displays. When you hover above this button, an Edit icon displays, allowing you to edit the text whenever you need to.
...
When you sign off, your user name displays below the "We agree with this decision" heading. If you change your mind, you can click the Remove icon that appears beside your name to remove your name from the agree list.

If no one signs off, and/or the decision has changed, you can click *Reopen Decision* to change the decision entered under "We decided...".
...
1.  In the *Create a Poll* dialog box, enter the following:
    ...
    -   **Anonymous Poll**: This is selected by default; workspace members can vote in the poll without revealing their names.
    -   **Public Poll \(Vote response will be shown\)**: Select if you want workspace members to see who voted for which option in the poll.
    -   **Allow users to select multiple options**: Enable to allow workspace members to select more than one option.
...
> ### Note:  
> To help prevent any manipulation in meaning of the question or answers, options can't be added or removed when editing polls.
...
2.  In the text box, enter the issue or item that requires consideration for pro or con and then click *Add topic*.
...
4.  To rank the items, click *Start Ranking*. Drag and drop the items to reorder them, with 1 being the highest ranking.
...
Allows you to create two or three columns with a list of options to compare.
...
3.  To enter a specific option for comparison, click *Add topic*. This adds a new row to the table.
